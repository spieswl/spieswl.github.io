...
date:               "2017-12-17"                            # Used for project sorting by date
...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/opening_lid.gif" style="width:308px; padding:8px 8px 8px 8px;">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/move_bottle.gif" style="width:370px; padding:8px 8px 12px 8px;">
</div>
