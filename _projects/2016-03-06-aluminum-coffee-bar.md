...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/P001.png" style="width:480px">
</div>
...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/P002.png" style="width:200px; margin:0px 16px 0px 16px; float:right">
</div>
...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/P003.jpg" style="width:270px; margin:0px 16px 0px 16px; float:left">
</div>
