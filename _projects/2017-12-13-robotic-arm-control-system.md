...
date:               "2017-12-13"                            # Used for project sorting by date
...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/youbot_home.png" style="width:480px">
</div>
...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/on-path_follower.gif" style="width:800px">
</div>
...
<div class="project-image">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/P_ctrl_results.png" style="width:540px">
    <img src="{{ site.url }}/{{ site.assets.projects }}/{{ page.specifics.images }}/PI_ctrl_results.png" style="width:540px">
</div>
